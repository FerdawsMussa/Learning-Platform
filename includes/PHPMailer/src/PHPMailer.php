...
class PHPMailer
{
     ...
     * Be aware that in PHP >= 5.6 this requires that the server's progress_certificates are valid.
     *
     * @var bool
     */
    ...
    /**
     * The optional S/MIME extra progress_certificates ("CA Chain") file path.
     *
     * @var string
     */
